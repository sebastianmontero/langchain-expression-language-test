...
CONTEXTUALIZE_QUESTION_TEMPLATE = """Given the following conversation and a follow up question, rephrase the 
...
Standalone question:"""
CONTEXTUALIZE_QUESTION_PROMPT = PromptTemplate.from_template(CONTEXTUALIZE_QUESTION_TEMPLATE)
...
def main():
    ...
    # contextualize_chain = RunnableMap(
    #     question = contextualize_q_prompt | contextualize_model | StrOutputParser() 
    # )

    # response = contextualize_chain.invoke({
    #     "chat_history":[
    #         ("human", "how old is harrison?"), 
    #         ("ai", "he is 30 years old")
    #     ],
